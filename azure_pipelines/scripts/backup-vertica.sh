...
#Directories
dir="https://$storageAccountName.blob.core.windows.net/weekly/$timeStamp/$storageAccountVertica/"
dirrecent="https://$storageAccountName.blob.core.windows.net/weekly/latest/$storageAccountVertica/"
dirvertica="https://$storageAccountVertica.blob.core.windows.net/vertica-backup-3101/*"
...
azcopy copy $dirvertica $dirrecent --recursive
echo "Latest backup starting"
azcopy copy $dirvertica $dir --recursive
