  ...
  inbound_security_rules = {
    ...
    "${local.subnet_key_names.aks_primary}" = {
      "InAllowAllInternal" = {
        ...
        protocol           = "*",
        port               = "*",
        src_address_prefix = var.PAIR_SUBNET_AKS_PRIMARY_CIDR,
      ...
      #   protocol           = "Tcp",
      #   port               = "5433",
      #   src_address_prefix = var.PAIR_SUBNET_AKS_DEVOPS_CIDR,
      #   dst_address_prefix = "VirtualNetwork",
      # },
      "InAllowAdoHTTPS" = {
        access             = "Allow",
  ...
  outbound_security_rules = {
    ...
    "${local.subnet_key_names.aks_primary}" = {
      ...
      "OutAllowKeyVaultHTTPSOutbound" = {
        ...
        port               = "443",
        src_address_prefix = "VirtualNetwork",
        dst_address_prefix = "AzureKeyVault.${var.PAIR_LOCATION}",
      },
      ...
      "OutAllowStorageHTTPSOutbound" = {
        ...
        port               = "443",
        src_address_prefix = "VirtualNetwork",
        dst_address_prefix = "Storage.${var.PAIR_LOCATION}",
      },
    ...
    "${local.subnet_key_names.aks_aml}" = {
      ...
      "OutAllowACRHTTPSOutbound" = {
        ...
        port               = "443",
        src_address_prefix = "AzureMachineLearning",
        dst_address_prefix = "AzureContainerRegistry.${var.PAIR_LOCATION}",
      },
