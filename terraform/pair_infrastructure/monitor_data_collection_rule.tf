...
resource "azurerm_monitor_data_collection_rule" "main" {
  ...
  destinations {
    log_analytics {
      ...
      name                  = "log-analytics-destination-log-${var.PAIR_LOCATION}"
    }
    # azure_monitor_metrics {
    #   name = "azure-monitor-metrics-destination-metrics-${var.PAIR_LOCATION}"
    # }
  }
  data_flow {
    ...
    destinations = ["log-analytics-destination-log-${var.PAIR_LOCATION}"]
  }
  #   data_flow {
  #     streams      = ["Microsoft-InsightsMetrics"]
  #     destinations = ["azure-monitor-metrics-destination-metrics-${var.PAIR_LOCATION}"]
  #   }
  data_sources {
    extension {
